...
void work() {
    ...
    for (int r5 = 0; r5 <= min(r4, a[5]); r5++) {
        if (r1 < a[1]) f[r1 + 1][r2][r3][r4][r5] += f[r1][r2][r3][r4][r5];
        if (r2 < a[2]) f[r1][r2 + 1][r3][r4][r5] += f[r1][r2][r3][r4][r5];
        if (r3 < a[3]) f[r1][r2][r3 + 1][r4][r5] += f[r1][r2][r3][r4][r5];
        if (r4 < a[4]) f[r1][r2][r3][r4 + 1][r5] += f[r1][r2][r3][r4][r5];
        if (r5 < a[5]) f[r1][r2][r3][r4][r5 + 1] += f[r1][r2][r3][r4][r5];
    }
